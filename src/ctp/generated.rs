...
pub enum EnumOnErrRtnEvent {
    None = 0,
    OnErrRtnOrderInsert = 1,
    OnErrRtnOrderAction = 2,
    OnErrRtnExecOrderInsert = 3,
    OnErrRtnExecOrderAction = 4,
    OnErrRtnForQuoteInsert = 5,
    OnErrRtnQuoteInsert = 6,
    OnErrRtnQuoteAction = 7,
    OnErrRtnBatchOrderAction = 8,
    OnErrRtnOptionSelfCloseInsert = 9,
    OnErrRtnOptionSelfCloseAction = 10,
    OnErrRtnCombActionInsert = 11,
    OnErrRtnBankToFutureByFuture = 12,
    OnErrRtnFutureToBankByFuture = 13,
    OnErrRtnRepealBankToFutureByFutureManual = 14,
    OnErrRtnRepealFutureToBankByFutureManual = 15,
    OnErrRtnQueryBankBalanceByFuture = 16,
}
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub enum EnumOnRspEvent {
    ...
    OnRspUserLogin = 1,
    OnRspUserLogout = 2,
    OnRspQryMulticastInstrument = 3,
    OnRspError = 4,
    OnRspSubMarketData = 5,
    OnRspUnSubMarketData = 6,
    OnRspSubForQuoteRsp = 7,
    OnRspUnSubForQuoteRsp = 8,
    OnRspAuthenticate = 9,
    OnRspUserPasswordUpdate = 10,
    OnRspTradingAccountPasswordUpdate = 11,
    OnRspUserAuthMethod = 12,
    OnRspGenUserCaptcha = 13,
    OnRspGenUserText = 14,
    OnRspOrderInsert = 15,
    OnRspParkedOrderInsert = 16,
    OnRspParkedOrderAction = 17,
    OnRspOrderAction = 18,
    OnRspQryMaxOrderVolume = 19,
    OnRspSettlementInfoConfirm = 20,
    OnRspRemoveParkedOrder = 21,
    OnRspRemoveParkedOrderAction = 22,
    OnRspExecOrderInsert = 23,
    OnRspExecOrderAction = 24,
    OnRspForQuoteInsert = 25,
    OnRspQuoteInsert = 26,
    OnRspQuoteAction = 27,
    OnRspBatchOrderAction = 28,
    OnRspOptionSelfCloseInsert = 29,
    OnRspOptionSelfCloseAction = 30,
    OnRspCombActionInsert = 31,
    OnRspQryOrder = 32,
    OnRspQryTrade = 33,
    OnRspQryInvestorPosition = 34,
    OnRspQryTradingAccount = 35,
    OnRspQryInvestor = 36,
    OnRspQryTradingCode = 37,
    OnRspQryInstrumentMarginRate = 38,
    OnRspQryInstrumentCommissionRate = 39,
    OnRspQryExchange = 40,
    OnRspQryProduct = 41,
...
pub enum EnumOnRtnEvent {
    None = 0,
    OnRtnDepthMarketData = 1,
    OnRtnForQuoteRsp = 2,
    OnRtnOrder = 3,
    OnRtnTrade = 4,
    OnRtnInstrumentStatus = 5,
    OnRtnBulletin = 6,
    OnRtnTradingNotice = 7,
    OnRtnErrorConditionalOrder = 8,
    OnRtnExecOrder = 9,
    OnRtnQuote = 10,
    OnRtnCFMMCTradingAccountToken = 11,
    OnRtnOptionSelfClose = 12,
    OnRtnCombAction = 13,
    OnRtnFromBankToFutureByBank = 14,
    OnRtnFromFutureToBankByBank = 15,
    OnRtnRepealFromBankToFutureByBank = 16,
    OnRtnRepealFromFutureToBankByBank = 17,
    OnRtnFromBankToFutureByFuture = 18,
    OnRtnFromFutureToBankByFuture = 19,
    OnRtnRepealFromBankToFutureByFutureManual = 20,
    OnRtnRepealFromFutureToBankByFutureManual = 21,
    OnRtnQueryBankBalanceByFuture = 22,
    OnRtnRepealFromBankToFutureByFuture = 23,
    OnRtnRepealFromFutureToBankByFuture = 24,
    OnRtnOpenAccountByBank = 25,
    OnRtnCancelAccountByBank = 26,
    OnRtnChangeAccountByBank = 27,
}
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
extern "C" {
    pub fn MdSetObject(pApi: *mut ::std::os::raw::c_void, pObject: *mut ::std::os::raw::c_void);
}
extern "C" {
...
extern "C" {
    pub fn TdSetObject(pApi: *mut ::std::os::raw::c_void, pObject: *mut ::std::os::raw::c_void);
}
extern "C" {
