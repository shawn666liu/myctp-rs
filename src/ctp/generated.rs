...
pub const THOST_FTDC_TPID_NewBESMarginAlgo: u8 = 108u8;
...
pub const THOST_FTDC_AS_Trade: u8 = 48u8;
pub const THOST_FTDC_AS_Member: u8 = 49u8;
#[repr(i32)]
...
pub enum EnumOnErrRtnEvent {
    ...
    OnErrRtnOffsetSetting = 16,
    OnErrRtnCancelOffsetSetting = 17,
}
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub enum EnumOnRspEvent {
    ...
    OnRspQryUserSession = 39,
    OnRspQryExchange = 40,
    OnRspQryProduct = 41,
    OnRspQryInstrument = 42,
    OnRspQryDepthMarketData = 43,
    OnRspQryTraderOffer = 44,
    OnRspQrySettlementInfo = 45,
    OnRspQryTransferBank = 46,
    OnRspQryInvestorPositionDetail = 47,
    OnRspQryNotice = 48,
    OnRspQrySettlementInfoConfirm = 49,
    OnRspQryInvestorPositionCombineDetail = 50,
    OnRspQryCFMMCTradingAccountKey = 51,
    OnRspQryEWarrantOffset = 52,
    OnRspQryInvestorProductGroupMargin = 53,
    OnRspQryExchangeMarginRate = 54,
    OnRspQryExchangeMarginRateAdjust = 55,
    OnRspQryExchangeRate = 56,
    OnRspQrySecAgentACIDMap = 57,
    OnRspQryProductExchRate = 58,
    OnRspQryProductGroup = 59,
    OnRspQryMMInstrumentCommissionRate = 60,
    OnRspQryMMOptionInstrCommRate = 61,
    OnRspQryInstrumentOrderCommRate = 62,
    OnRspQrySecAgentTradingAccount = 63,
    OnRspQrySecAgentCheckMode = 64,
    OnRspQrySecAgentTradeInfo = 65,
    OnRspQryOptionInstrTradeCost = 66,
    OnRspQryOptionInstrCommRate = 67,
    OnRspQryExecOrder = 68,
    OnRspQryForQuote = 69,
    OnRspQryQuote = 70,
    OnRspQryOptionSelfClose = 71,
    OnRspQryInvestUnit = 72,
    OnRspQryCombInstrumentGuard = 73,
    OnRspQryCombAction = 74,
    OnRspQryTransferSerial = 75,
    OnRspQryAccountregister = 76,
    OnRspQryContractBank = 77,
    OnRspQryParkedOrder = 78,
    OnRspQryParkedOrderAction = 79,
    OnRspQryTradingNotice = 80,
    OnRspQryBrokerTradingParams = 81,
    OnRspQryBrokerTradingAlgos = 82,
    OnRspQueryCFMMCTradingAccountToken = 83,
    OnRspFromBankToFutureByFuture = 84,
    OnRspFromFutureToBankByFuture = 85,
    OnRspQueryBankAccountMoneyByFuture = 86,
    OnRspQryClassifiedInstrument = 87,
    OnRspQryCombPromotionParam = 88,
    OnRspQryRiskSettleInvstPosition = 89,
    OnRspQryRiskSettleProductStatus = 90,
    OnRspQrySPBMFutureParameter = 91,
    OnRspQrySPBMOptionParameter = 92,
    OnRspQrySPBMIntraParameter = 93,
    OnRspQrySPBMInterParameter = 94,
    OnRspQrySPBMPortfDefinition = 95,
    OnRspQrySPBMInvestorPortfDef = 96,
    OnRspQryInvestorPortfMarginRatio = 97,
    OnRspQryInvestorProdSPBMDetail = 98,
    OnRspQryInvestorCommoditySPMMMargin = 99,
    OnRspQryInvestorCommodityGroupSPMMMargin = 100,
    OnRspQrySPMMInstParam = 101,
    OnRspQrySPMMProductParam = 102,
    OnRspQrySPBMAddOnInterParameter = 103,
    OnRspQryRCAMSCombProductInfo = 104,
    OnRspQryRCAMSInstrParameter = 105,
    OnRspQryRCAMSIntraParameter = 106,
    OnRspQryRCAMSInterParameter = 107,
    OnRspQryRCAMSShortOptAdjustParam = 108,
    OnRspQryRCAMSInvestorCombPosition = 109,
    OnRspQryInvestorProdRCAMSMargin = 110,
    OnRspQryRULEInstrParameter = 111,
    OnRspQryRULEIntraParameter = 112,
    OnRspQryRULEInterParameter = 113,
    OnRspQryInvestorProdRULEMargin = 114,
    OnRspQryInvestorPortfSetting = 115,
    OnRspQryInvestorInfoCommRec = 116,
    OnRspQryCombLeg = 117,
    OnRspOffsetSetting = 118,
    OnRspCancelOffsetSetting = 119,
    OnRspQryOffsetSetting = 120,
}
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub type TThostFtdcAddrSrvModeType = ::std::os::raw::c_uchar;
pub type TThostFtdcAddrVerType = ::std::os::raw::c_uchar;
pub type TThostFtdcAddrRemarkType = [::std::os::raw::c_uchar; 161usize];
pub type TThostFtdcAddrNameType = [::std::os::raw::c_uchar; 65usize];
pub type TThostFtdcIpAddrType = [::std::os::raw::c_uchar; 129usize];
pub type TThostFtdcTGSessionQryStatusType = ::std::os::raw::c_uchar;
pub type TThostFtdcOffsetTypeType = ::std::os::raw::c_uchar;
pub type TThostFtdcSiteType = [::std::os::raw::c_uchar; 51usize];
pub type TThostFtdcNetOperatorType = [::std::os::raw::c_uchar; 9usize];
pub type TThostFtdcApplySrcType = ::std::os::raw::c_uchar;
pub type TThostFtdcReserveInfoType = [::std::os::raw::c_uchar; 65usize];
#[repr(C)]
...
pub struct CThostFtdcRspUserLoginField {
    ...
    pub ReserveInfo: TThostFtdcReserveInfoType,
}
...
pub struct CThostFtdcOffsetSettingField {
    ...
    pub ApplySrc: TThostFtdcApplySrcType,
}
...
impl Default for CThostFtdcWechatUserSystemInfoField {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct CThostFtdcInvestorReserveInfoField {
    pub BrokerID: TThostFtdcBrokerIDType,
    pub UserID: TThostFtdcUserIDType,
    pub ReserveInfo: TThostFtdcReserveInfoType,
}
impl Default for CThostFtdcInvestorReserveInfoField {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct CThostFtdcQryInvestorDepartmentFlatField {
    pub BrokerID: TThostFtdcBrokerIDType,
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct CThostFtdcInvestorDepartmentFlatField {
    pub BrokerID: TThostFtdcBrokerIDType,
    pub InvestorID: TThostFtdcInvestorIDType,
    pub DepartmentID: TThostFtdcInvestorIDType,
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct CThostFtdcQryDepartmentUserField {
    pub BrokerID: TThostFtdcBrokerIDType,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
