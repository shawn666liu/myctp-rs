...
pub enum EnumOnRspEvent {
    ...
    OnRspQrySettlementInfo = 43,
    OnRspQryTransferBank = 44,
    OnRspQryInvestorPositionDetail = 45,
    OnRspQryNotice = 46,
    OnRspQrySettlementInfoConfirm = 47,
    OnRspQryInvestorPositionCombineDetail = 48,
    OnRspQryCFMMCTradingAccountKey = 49,
    OnRspQryEWarrantOffset = 50,
    OnRspQryInvestorProductGroupMargin = 51,
    OnRspQryExchangeMarginRate = 52,
    OnRspQryExchangeMarginRateAdjust = 53,
    OnRspQryExchangeRate = 54,
    OnRspQrySecAgentACIDMap = 55,
    OnRspQryProductExchRate = 56,
    OnRspQryProductGroup = 57,
    OnRspQryMMInstrumentCommissionRate = 58,
    OnRspQryMMOptionInstrCommRate = 59,
    OnRspQryInstrumentOrderCommRate = 60,
    OnRspQrySecAgentTradingAccount = 61,
    OnRspQrySecAgentCheckMode = 62,
    OnRspQrySecAgentTradeInfo = 63,
    OnRspQryOptionInstrTradeCost = 64,
    OnRspQryOptionInstrCommRate = 65,
    OnRspQryExecOrder = 66,
    OnRspQryForQuote = 67,
    OnRspQryQuote = 68,
    OnRspQryOptionSelfClose = 69,
    OnRspQryInvestUnit = 70,
    OnRspQryCombInstrumentGuard = 71,
    OnRspQryCombAction = 72,
    OnRspQryTransferSerial = 73,
    OnRspQryAccountregister = 74,
    OnRspQryContractBank = 75,
    OnRspQryParkedOrder = 76,
    OnRspQryParkedOrderAction = 77,
    OnRspQryTradingNotice = 78,
    OnRspQryBrokerTradingParams = 79,
    OnRspQryBrokerTradingAlgos = 80,
    OnRspQueryCFMMCTradingAccountToken = 81,
    OnRspFromBankToFutureByFuture = 82,
    OnRspFromFutureToBankByFuture = 83,
    OnRspQueryBankAccountMoneyByFuture = 84,
    OnRspQryClassifiedInstrument = 85,
    OnRspQryCombPromotionParam = 86,
}
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
